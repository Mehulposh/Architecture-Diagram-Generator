...
export default function Toolbar() {
  const { projectName, setProjectName, saveProject, user, logout, setDocsOpen, documentation, userFlowOverview, erOverview, diagramView, setDiagramView, theme, toggleTheme } = useDiagramStore();
  ...
  return (
    <header className="flex items-center justify-between border-b border-blueprint-line/30 bg-blueprint-950 px-5 py-3">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <button
          onClick={toggleTheme}
          title={theme === 'dark' ? 'Switch to light (diazo print) theme' : 'Switch to dark theme'}
